> **_NOTE:_**  the formal [Data Solution Automation Schema documentation](https://data-engine-thinking.github.io/data-solution-automation-metadata-schema/) is now available as a website.
