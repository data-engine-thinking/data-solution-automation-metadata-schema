...
description: 'A reference to a template file that should be applied to the parent object. Template mappings let metadata travel together with the templates used to generate code from it.'
---
...
|---|---|---|
| `templateFileName` | `string` | The file name of the template to apply. |
